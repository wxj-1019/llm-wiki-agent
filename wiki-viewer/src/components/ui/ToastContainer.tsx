...
export function ToastContainer() {
  ...
  return (
    <div className="fixed top-16 right-4 z-[60] space-y-2 pointer-events-none" aria-live="polite" aria-atomic="true" role="status">
      <AnimatePresence>
        {toasts.map((toast) => {
          ...
          return (
            <motion.div
              ...
              className={`pointer-events-auto w-80 flex flex-col gap-2 px-4 py-3 rounded-xl border shadow-lg backdrop-blur-sm ${colorMap[toast.type]}`}
            >
