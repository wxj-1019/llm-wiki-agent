...
- 采用Facade模式聚合[[PortfolioStrategyAgent]]、[[DynamicWeightAdjuster]]、[[HealthAssessmentAgent]]、[[StressTestingAgent]]和[[RiskIdentificationAgent]]五个智能体
...
- [[RiskManagement|风险管理]] — [[RiskIdentificationAgent|风险识别智能体]]和[[StressTestingAgent|压力测试智能体]]直接服务于组合层面的风险管理
